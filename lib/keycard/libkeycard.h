...
/* package github.com/status-im/status-keycard-go/shared */
...
extern char* MockedLibRegisterKeycard(int cardIndex, int readerState, int keycardState, char* mockedKeycard, char* mockedKeycardHelper);
extern char* MockedLibReaderPluggedIn(void);
extern char* MockedLibReaderUnplugged(void);
extern char* MockedLibKeycardInserted(int cardIndex);
extern char* MockedLibKeycardRemoved(void);
